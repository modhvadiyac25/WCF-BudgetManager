...
<html>
    ...
    <body>
        ...
        <div class="divClass">
            ...
            <form action="assessExpense"> 
                <label for="exp_cat"><h4><b>Select Your expense Category</b></h4></label>
                          
                <select id="exp_cat" name="expense">
                    
                    <option> </option>
                </select>
                <h4><b>Enter Your Expense Below</b></h4>
